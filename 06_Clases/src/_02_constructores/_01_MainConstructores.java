...
public class _01_MainConstructores {
	...
	public static void main(String[] args) {
		// siempre tendremos que crear un objeto a travez de un constructor
		...
		//vamos a invocar al constructor con parametros
		...
		Persona p4 =new Persona("peater parker", 16, 65.37, false);
