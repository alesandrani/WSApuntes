...
public class _09_Funciones_01 {
	...
	public static void main(String[] args) {
		System.out.println("Bienvendios a las funciones o métodos en Java");
		System.out.println("---------------------------------------------");
		System.out.println("---------------------------------------------");
		...
		String nombreFinal =concatenarNombreYApellidos("Gabriel", "Garcia Marques");
	...
	//metodo con un parametro de entrada y un parametro de salida
	public static int calcularPotenciaCuadrada(int numero) {
		int potencia = numero * numero;
		return potencia;
	}
	// metodo con dos parametros de entrada y un parametro de salida
	//nota: lo parametros de entrada van de 0...N
	//       loa parametros de salida van de 0..1
	public static String concatenarNombreYApellidos(String nombre, String apellido) {
		//no pueden haber 2 variables iguales 
		//hay una de entrada
		//String nombre = "Felix";ERROR, ya existe variable nombre
