...
class _06_Converciones {
	...
	public static void main(String[] args) {
		...
		//introducir un tipo de datomas grande en un tipo de dato mas pequeño
		//ejemplo: si queremos intriducir un long en un int
		//debemos hacer SIEMPRE un cast, al reves no haria falta
		...
		//tipos de datos oredenados de mayor a menor de numeros enteros
		//long>int>char=short>byte
		//tipos de datos ordenados de mayor a menor en punto flotante
		//double> float
		//simepre que hagamos un cast de numero flotant a un numero simpre vamos a perder la parte decimal
